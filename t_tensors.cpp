...
//    print1DArray(nCols,g);
    ...
    f12e     = sum2DArrays(nCols,nCols,scalar1DArrayMultip(nCols,(c12-5.0*c1*c2),r12_hat),scalar1DArrayMultip(nCols,c2,e1)) ;
    f12e     = sum2DArrays(nCols,nCols,f12e,scalar1DArrayMultip(nCols,c1,e2));
...
//    print1DArray(nCols,t1t);
    ...
    f12e = sum2DArrays(nCols,nCols,h1,f12e);
    f12e = sum2DArrays(nCols,nCols,h2,f12e);                                            // Compare result from angles
...
//    print1DArray(nCols,f12e);
    ...
    g   = sum2DArrays(nCols,nCols,g,scalar1DArrayMultip(nCols, 2.0*c2, e2));            // Compare result from angles
    ...
    g   = sum2DArrays(nCols,nCols,g,scalar1DArrayMultip(nCols,c2, e1));                                        // Compare result from angles
